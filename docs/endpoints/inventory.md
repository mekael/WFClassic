...
```json
{
    ...
    "Created": {
        "$date": {
            "$numberLong": "1744610332537"
        }
    },
    "updatedAt": "2025-04-15T05:35:04.166Z",
    "NextRefill": {
        "$date": {
